%% RF line simulator
%
% Simulates the element RF echo data coming from a single microbubbles in a
...
Pmin = 1;                   % Minimum acoustic pressure (kPa)
Pmax = 250;                 % Maximum acoustic pressure (kPa)
PA_list = Pmin:Pmin:Pmax;  	% List of acoustic pressures (kPa)
...
bubble.z  = domain.d1;   	% Axial coordinate bubble (m)
