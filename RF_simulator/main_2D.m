...
PA = 2.046e5;               % Acoustic pressure amplitude (Pa)
...
for n = 1:NSIM  
    ...
    %% Get bubble locations from file. Allocate random radius. 
    load('bubbles_locations.mat')
    [bubble, shell] = getBubblesOld(bubble,R0,sR0,liquid,...
    ...
    filename = sprintf("RFDATA2D%05.0f", n);
