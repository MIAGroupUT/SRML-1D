...
elseif strcmp(shell.model,'SegersTable')
	% Experimental surface tension curve from Segers et al., Soft Matter, 
    % 2018, 14, 9550-9561. Computed for predefined array A_m_list. Compute
    % for A_m through interpolation.
    ...
    % interpolation:
    sig(A_m>A_m1 & A_m<A_m2) = ...
        interp1(shell.A_m_list, shell.sig, A_m(A_m>A_m1 & A_m<A_m2));
