function [bubble, shell] = getBubblesPolydisperse(Nb, R, P, domain, ...
    liquid, shell_model,sig_0,r0)
% Randomly distribute Nb bubbles in a rectangular domain. The size 
% distribution of the bubbles is based on SonoVue. Based on the radius of
...
R0v = getRandomRadius(P,R,Nb);     	% Bubble radii (um);
