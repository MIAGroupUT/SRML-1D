...
filedir = ...               % Save directory for simulation results
    ['/home/blankenn/SuperResolutionProjectREVISION/'...
...
% Size distribution (P) of SonoVue, radius (R) in um
[R,P] = getPolydisperseDistribution();
...
for n = 1:NSIM  
    ...
    [bubble, shell] = getBubblesPolydisperse(Nb, R, P, domain, ...
