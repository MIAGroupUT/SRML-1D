...
savedir   = '/home/blankenn/BubbleSimulations/Network_FINAL/modelS_1'
...
epsilon2 = 0        # Proportionality constant Dice loss
a = 1               # Width paramater gaussian convolution kernel  
